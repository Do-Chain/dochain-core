...
func TestGenesisAccountValidate(t *testing.T) {
	...
	initialVesting := sdk.NewCoins(sdk.NewInt64Coin(core.MicroDoDenom, 50))
	...
	tests := []struct {
		...
		},
		{
			...
			types.NewLazyGradedVestingAccount(baseAcc, initialVesting, types.VestingSchedules{types.VestingSchedule{core.MicroDoDenom, types.Schedules{types.Schedule{1554668078, 1654668078, sdkmath.LegacyOneDec()}}}}),
			nil,
		},
		{
			"invalid vesting times",
			types.NewLazyGradedVestingAccount(baseAcc, initialVesting, types.VestingSchedules{types.VestingSchedule{core.MicroDoDenom, types.Schedules{types.Schedule{1654668078, 1554668078, sdkmath.LegacyOneDec()}}}}),
			errors.New("vesting start-time cannot be before end-time"),
		},
		{
			"invalid vesting times 2",
			types.NewLazyGradedVestingAccount(baseAcc, initialVesting, types.VestingSchedules{types.VestingSchedule{core.MicroDoDenom, types.Schedules{types.Schedule{-1, 1554668078, sdkmath.LegacyOneDec()}}}}),
			errors.New("vesting start-time cannot be negative"),
		},
		{
			"invalid vesting ratio",
			types.NewLazyGradedVestingAccount(baseAcc, initialVesting, types.VestingSchedules{types.VestingSchedule{core.MicroDoDenom, types.Schedules{types.Schedule{1554668078, 1654668078, sdkmath.LegacyZeroDec()}}}}),
			errors.New("vesting ratio cannot be smaller than or equal with zero"),
		},
		{
			"invalid vesting sum of ratio",
			types.NewLazyGradedVestingAccount(baseAcc, initialVesting, types.VestingSchedules{types.VestingSchedule{core.MicroDoDenom, types.Schedules{types.Schedule{1554668078, 1654668078, sdkmath.LegacyNewDecWithPrec(1, 1)}}}}),

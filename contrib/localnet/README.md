...
1. Keys
The simulation will add these normal [addresses](simulation/network/localdo/keys.json) to keyring. Query `dochaind keys list --keyring-backend test` to see.

For validator mnemonic, please look at build/node0/dochaind/key_seed.json. This file will only be created after setting up localnet.

2. Processes
* Validator addresses will send udotest to normal addresses

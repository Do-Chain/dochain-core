...
func NewAppKeepers(
	...
	appKeepers.StakingKeeper.SetHooks(
		stakingtypes.NewMultiStakingHooks(customstaking.NewDoStakingHooks(*appKeepers.StakingKeeper), appKeepers.DistrKeeper.Hooks(), appKeepers.SlashingKeeper.Hooks()),
	)
	...
	wasmOpts = append(wasmOpts, dochainwasm.RegisterLegacyQueryHandler(appKeepers.keys[wasmtypes.StoreKey]))

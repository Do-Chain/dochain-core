	...
	}{
		{
			txs: []testTx{
				...
				},
				{
					id:      2,
					nonce:   1,
					msgs:    []sdk.Msg{&oracleexported.MsgAggregateDoRateVote{}},
					address: sb,
				},
			},
			numberTxOracle: 1,
		...
		},
		{
			...
			txs: []testTx{
				...
				},
				{
					id:      3,
					nonce:   1,
					msgs:    []sdk.Msg{&oracleexported.MsgAggregateDoRatePrevote{}},
					address: sb,
				},
			},
			numberTxOracle: 2,
...
func (s *MempoolTestSuite) TestBatchTx_WhenEnoughMemPool() {
	...
	for i := 0; i < 50; i++ {
		var msg sdk.Msg
		if i%2 == 0 {
			msg = &oracleexported.MsgAggregateDoRateVote{
				Salt: fmt.Sprintf("salt_vote_%d", i),
			}
		} else {
			msg = &oracleexported.MsgAggregateDoRatePrevote{

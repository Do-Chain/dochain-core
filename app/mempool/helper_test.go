...
// unsignedTestTx implements sdk.Tx but deliberately not SigVerifiableTx.
type unsignedTestTx struct{}

func (unsignedTestTx) GetMsgs() []sdk.Msg { return nil }

func (unsignedTestTx) GetMsgsV2() ([]proto.Message, error) { return nil, nil }

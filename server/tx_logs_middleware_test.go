...
// Do-Chain wasm execute contract transaction payload from mainnet
...
func TestRealWasmExecuteTxLogsReconstruction(t *testing.T) {
	// Real transaction response from Do-Chain mainnet
...
// Do-Chain bank send transaction that includes tax_payment events from mainnet
...
// Do-Chain oracle multi-message transaction from mainnet
// TX: A7075AA154D7D4DCBAB70465EAF85168CED8C76E700CC30142DBA46F1D80E0F2
// This transaction contains TWO messages:
// 1. MsgAggregateDoRateVote (msg_index: 0)
// 2. MsgAggregateDoRatePrevote (msg_index: 1)
func TestRealOracleMultiMessageTxLogsReconstruction(t *testing.T) {
	...
	realTxResponse := `{
		...
		"tx_response": {
			...
			"raw_log": "[{\"msg_index\":0,\"events\":[{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"/do.oracle.v1beta1.MsgAggregateDoRateVote\"},{\"key\":\"sender\",\"value\":\"do19p69dm52exmhtyklgcpd2jrfwtv0awlp0ve63z\"}]},{\"type\":\"aggregate_vote\",\"attributes\":[{\"key\":\"voter\",\"value\":\"dovaloper1j5pj3n3m9nxmv9dgl4wnv2yq53k2jf2283j5zm\"},{\"key\":\"exchange_rates\",\"value\":\"0.000066097941407884uaud,0.000061456692115652ucad,0.00003538288127528uchf,0.00030892650733513ucny,0.000283966498350392udkk,0.00003800111245669ueur,0.000032909024645851ugbp,0.000345525060444445uhkd,0.746825090789225464uidr,0.003995990890723461uinr,0.007034943470680445ujpy,0.065282105991835183ukrw,0.0umnt,0.00017969339697793umyr,0.000446742366801887unok,0.002633155589658828uphp,0.000032429987267087usdr,0.000407127883304437usek,0.00005702359065234usgd,0.001393924629462205uthb,0.0utwd,0.000044286727883801uusd\"}]},{\"type\":\"message\",\"attributes\":[{\"key\":\"module\",\"value\":\"oracle\"},{\"key\":\"sender\",\"value\":\"do19p69dm52exmhtyklgcpd2jrfwtv0awlp0ve63z\"}]}]},{\"msg_index\":1,\"events\":[{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"/do.oracle.v1beta1.MsgAggregateDoRatePrevote\"},{\"key\":\"sender\",\"value\":\"do19p69dm52exmhtyklgcpd2jrfwtv0awlp0ve63z\"}]},{\"type\":\"aggregate_prevote\",\"attributes\":[{\"key\":\"voter\",\"value\":\"dovaloper1j5pj3n3m9nxmv9dgl4wnv2yq53k2jf2283j5zm\"}]},{\"type\":\"message\",\"attributes\":[{\"key\":\"module\",\"value\":\"oracle\"},{\"key\":\"sender\",\"value\":\"do19p69dm52exmhtyklgcpd2jrfwtv0awlp0ve63z\"}]}]}]",
			"logs": [],
			"info": "",
			"gas_wanted": "300000",
			"gas_used": "110287",
			...
			"events": [
				...
				},
				{
					"type": "message",
					"attributes": [
						{"key": "action", "value": "/do.oracle.v1beta1.MsgAggregateDoRateVote", "msg_index": 0},
				...
				},
				{
					"type": "message",
					"attributes": [
						{"key": "action", "value": "/do.oracle.v1beta1.MsgAggregateDoRatePrevote", "msg_index": 1},
	...
	// Verify first log (msg_index: 0 - MsgAggregateDoRateVote)
	log0 := logs[0]
	...
	// Verify second log (msg_index: 1 - MsgAggregateDoRatePrevote)
	log1 := logs[1]
